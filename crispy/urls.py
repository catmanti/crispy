...
from crispy.views import PatientListView, PatientDetailView, PatientCreateView, PatientUpdateView, PatientDeleteView, test, HistoryDetailView, HistoryCreateView, HistoryUpdateView, HistoryDeleteView
...
urlpatterns = [
    ...
    path('hiscreate/', HistoryCreateView.as_view(), name='patient_create'),
